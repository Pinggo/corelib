...
import com.dev.pipi.commlib.util.AudioUtil;
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            switch (motionEvent.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    mSoundData = dataPath + getRandomFileName() + ".wav";
                    try {
                        audioUtil.setOutFileName(mSoundData);
...
//                        deleteSoundFileUnSend();
    ...
    public void stopRecord() {
        ...
        mSoundData = audioUtil.getOutFileName();
