...
public class FileUtils {
    ...
    public static void openFiles(Context context, String filesPath) {
        ...
        if (Build.VERSION.SDK_INT > 23) {
            fileUri = FileProvider.getUriForFile(context, context.getPackageName() + ".provider", new File(filesPath));
        } else {
            fileUri = Uri.fromFile(new File(filesPath));
        }
    ...
    public static Intent showOpenTypeDialog(Context context,String param) {
        ...
        Uri fileUri;
        if (Build.VERSION.SDK_INT > 23) {
            fileUri = FileProvider.getUriForFile(context, context.getPackageName() + ".provider", new File(param));
        } else {
